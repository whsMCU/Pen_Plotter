...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
{
  {GPIOB, GPIO_PIN_2,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_HIGH}, //  0. LED
	...
	{GPIOA, GPIO_PIN_3,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  4. StepX_EN
	{GPIOA, GPIO_PIN_1,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  5. StepX_STEP
	{GPIOA, GPIO_PIN_4,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  6. StepX_DIR

	{GPIOA, GPIO_PIN_5,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  7. StepY_EN
	{GPIOA, GPIO_PIN_2,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  8. StepY_STEP
	{GPIOA, GPIO_PIN_6,  _DEF_OUTPUT,   		 		  GPIO_PIN_SET,   GPIO_PIN_RESET, _DEF_LOW},  //  9. StepY_DIR
};
